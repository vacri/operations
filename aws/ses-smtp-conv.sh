#!/bin/bash
# pinched from https://www.lisenet.com/2014/amazon-ses-smtp-outbound-email-configuration-with-ssmtp-on-debian/
...
if [ "$#" -ne "2" ];then
  echo "Usage: ./ses-smtp-conv.sh IAMUSER IAMSECRET ";
